...
import '../modules/ChatScreen/StoryViewScreen/bindings/story_screen_binding.dart';
import '../modules/ChatScreen/StoryViewScreen/views/story_view_screen_view.dart';
import '../modules/ChatScreen/bindings/chat_screen_binding.dart';
import '../modules/ChatScreen/views/add_story_screen.dart';
  ...
  static final routes = [
    ...
    GetPage(
      ...
      children: [
        ...
        GetPage(
          name: _Paths.STORY_VIEW_SCREEN,
          page: () => const ChatScreenStoryViewScreenView(),
          binding: ChatScreenStoryViewScreenBinding(),
        ),
      ],
    ),
    GetPage(
